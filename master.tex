...
parameters with $\log g$ fixed to the literature value (orange), and derived
parameters when $\log g$ is free during the minimization procedure (green
points).}
...
\begin{figure}[htpb!]
    ...
    \caption{Parameters for Arcturus, 10 Leo, and HD 20010 (revisited in this
             ...
             database as discussed in the text. The orange points are the
             derived values with $\log g$ fixed to the literature value, and the
             green points show the derived parameters when $\log g$ is also
             derived.}
...
\ref{tab:arcturus} together with mean parameters from the literature.
