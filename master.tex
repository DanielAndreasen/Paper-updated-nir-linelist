...
to measure one \ion{Fe}{II} line, which are very important to determine the
surface gravity.
...
\begin{figure*}[tpb]
    ...
    \caption{The spectrum of the two stars, in blue is Arcturus, and red dashed
             is 10 Leo. We mark the location of \ion{Fe}{I} lines in the region.}
    \label{fig:both}
\end{figure*}
...
Paper I. We removed 342 \ion{Fe}{I} lines and 13 \ion{Fe}{II}
