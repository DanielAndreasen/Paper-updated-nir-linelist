...
gaps and as we will see below, we were unable to measure one \ion{Fe}{II} line which are generally
...
\begin{table*}[htb!]
  ...
  \tablefoottext{b}{See references in Paper I}
  \tablefoottext{c}{\citet{Park2013,Luck2015,Massarotti2008,Soubiran2008,daSilva2011}}
}
\end{table*}
...
Paper I as we prepared a \ion{Fe}{I} and \ion{Fe}{II} line list in the NIR domain. The atomic data
...
tellurics}. In total 211 out of 295 \ion{Fe}{I} lines and 8 out of 13 \ion{Fe}{II} lines were
...
With themethodology we use in the present paper to derive stellar parameters, the \ion{Fe}{II} lines
are used to determine $\log g$ by imposing ionization balance with the average \ion{Fe}{I}
abundance. However, the low number of \ion{Fe}{II} lines available is a concern, since the average
abundance of \ion{Fe}{II} is affected more by small number statistics compared to the numerous
\ion{Fe}{I} lines.
...
As a test, and given the small number of available \ion{Fe}{II} lines, we adopted two different
...
latter approach does not make use of \ion{Fe}{II} lines.
