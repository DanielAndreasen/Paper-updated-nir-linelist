...
211 \ion{Fe}{I} lines and 8 \ion{Fe}{II} lines were removed in the process. Most
of these were blended lines with either tellurics or other stellar lines. This
procedure leaves us with 84 \ion{Fe}{I} lines and 5 \ion{Fe}{II} lines. These
...
more by outliers compared to the \ion{Fe}{I} lines. One might set $\log g$ fixed
...
be able to measure these \ion{Fe}{II} lines.
