...
The results are shown in Table \ref{tab:results} along with the average
...
\begin{table}[htb!]
    \caption{Results for the three stars with first the literature values as
             presented in Table.~\ref{tab:stars}, second line are results with
             $\log g$ set to the same value during the minimization procedure
             as found in the literature (fixed), and last line is with all
             parameters free during the minimization procedure.}
    \label{tab:results}
    \centering
    \begin{tabular}{llll}
      \hline\hline
...
were also measured by hand using IRAF.
